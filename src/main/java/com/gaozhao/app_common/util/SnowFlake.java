 ...
 * @version: v1.0.0
 * @author: lvyonggang
 * @date: 2017年10月8日 下午3:52:10 
 *
 * Modification History:
 * Date         Author          Version            Description
 *---------------------------------------------------------*
 * 2017年10月8日      lvyonggang          v1.0.0             创建
 */
public class SnowFlake {
    ...
    /**
     * 
    * @Function: SnowFlake.java
    * @Description: 使用默认的数据中心0，机器标识0生成ID 
    *
    * @return 返回一个64位的整形id
    * 
    * @version: v1.0.0
    * @author: lvyonggang
    * @date: 2017年10月15日 下午5:33:36 
    *
    * Modification History:
    * Date         Author          Version            Description
    *---------------------------------------------------------*
    * 2017年10月15日     lvyonggang           v1.0.0            创建
     */
