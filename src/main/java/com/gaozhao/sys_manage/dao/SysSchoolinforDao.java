...
@Mapper
public interface SysSchoolinforDao{
	/**
	...
	/**
	 * 批量插入SysSchoolinfor到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateSysSchoolinfor(@Param("enti") SysSchoolinfor value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySysSchoolinfor(@Param("enti") SysSchoolinfor value, @Param("assist") Assist assist);

	Long getSysSchoolListCount(SysSchoolFormPage sysSchoolFormPage);

	List<SysSchoolinfor> getSysSchoolList(SysSchoolFormPage sysSchoolFormPage);
}