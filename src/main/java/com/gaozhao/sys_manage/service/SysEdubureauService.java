...
public interface SysEdubureauService{
	/**
	 ...
	 * @return
	 */
    int updateSysEdubureau(SysEdubureau value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySysEdubureau(SysEdubureau value, Assist assist);


    int deleteBatchSysEdubureau(List<String> ids);

    Page getSysEduBureauList(SysEduBureauFromPage sysEduBureauFromPage);
}